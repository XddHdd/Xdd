...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wxf8f55912f4b1e772',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '6d15dc9b5fdd8b8fbc354f2a7ca903b2',
  ...
  USERS: [
    {
      ...
      id: 'okFwv5sRe51cEbe_62LPW8GfZqRc',id:'okFwv5qJrjalOqe3Vm7ebrqnbTk0',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '_hzQIwJrVpya59sH5g7OUjjFgiQYuKvqGwO1C8-eLJc',
      // 所在省份
      province: '湖南',
      // 所在城市
      city: '岳阳',
      ...
      openUrl: 'https://www.1212.com/luck/pisces/',
      // 专属节日提醒，如果你在这里填写了节日提醒，就不会执行FESTIVALS的提醒了, 和FESTIVALS的配置方法相同，可以往下查看，我这里就不重复写了
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
        {
          type: '*生日', name: '局局啵', year: '2002', date: '02-25',
        },
        {
          type: '节日', name: '一周年', year: '2022', date: '09-08',
        },
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {
          type: '生日', name: '好脾气', year: '2002', date: '07-11',
        },
        {
          type: '节日', name: '认识一周年', year: '2022', date: '08-31',
        }
      ],
